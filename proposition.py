...
class Proposition(object):
    ...
    title = property(get_title, set_title, doc="The title of the document.")
    date = property(get_date, set_date, doc="The date that document records.")
    link = property(get_link, set_link, doc="Link to the document.")
    party = property(get_party, set_party,
                     doc="The party that initiated the proposition")
    proposition_nbr = property(get_proposition_nbr, set_proposition_nbr,
                               doc="Number of the proposition")
    updateDate = property(get_update_date, set_update_date,
                          doc="The date the proposition was updated")
    statement = property(get_statement, set_statement,
                         doc="The statement of the document")
    subject = property(get_subject, set_subject,
                       doc="The subject of the document")
    result = property(get_result, set_result, doc="The result of the document")
    obnumber = property(get_obnumber, set_obnumber, del_obnumber,
                        doc="obnumber's docstring")
